...
INSERT INTO contacts(name, email, message) VALUES('Isaac Newton', 'newtonian_physics@apple.com', 'Dear Scott, I am seeking..');
INSERT INTO contacts(name, email, message) VALUES('Stephen Hawking', 'hawking_cosmos@blackholemail.com', 'Greetings Scott, I am interested...');
INSERT INTO contacts(name, email, message) VALUES('Galileo Galilei', 'stargazer_galileo@telescopemail.com', 'Hello Scott, I wish to commission...');
INSERT INTO contacts(name, email, message) VALUES('Leonardo da Vinci', 'leonardo_innovations@renaissancecreator.com', 'Dear Scott, I am in pursuit...');